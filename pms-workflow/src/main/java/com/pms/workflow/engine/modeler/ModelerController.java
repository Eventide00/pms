package com.pms.workflow.engine.modeler;
...
import static com.pms.common.core.domain.AjaxResult.error;
import static com.pms.common.core.domain.AjaxResult.success;
...
public class ModelerController extends BaseController {
    ...
    public TableDataInfo list(ModelEntityImpl modelEntity) {
        ...
        // 条件过滤
        if (com.pms.common.utils.StringUtils.isNotBlank(modelEntity.getKey())) {
            modelQuery.modelKey(modelEntity.getKey());
        }
        if (com.pms.common.utils.StringUtils.isNotBlank(modelEntity.getName())) {
