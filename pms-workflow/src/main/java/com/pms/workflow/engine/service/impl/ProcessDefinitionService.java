package com.pms.workflow.engine.service.impl;
...
import com.pms.common.core.page.PageDomain;
import com.pms.common.core.page.TableSupport;
...
public class ProcessDefinitionService implements IProcessDefinitionService {
     ...
     */
    @Override
    public Page<com.pms.workflow.engine.entity.ProcessDefinition> listProcessDefinition(com.pms.workflow.engine.entity.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.pms.workflow.engine.entity.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition : processDefinitionList) {
            ...
            com.pms.workflow.engine.entity.ProcessDefinition entity = new com.pms.workflow.engine.entity.ProcessDefinition();
